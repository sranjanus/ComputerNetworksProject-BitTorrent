 ...
 * ******************************************************************************
 * Purpose: This class is responsible for file writing and file reading and fragmenting it into number of chunks
 * depending on the chunk size.
 *
 * Description: The functions are responsible opening the folders and the file.
 * and getting the correct piece in the file to be transferred
 *
 *
