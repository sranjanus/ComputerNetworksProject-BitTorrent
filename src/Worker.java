...
//            }
            ...
            try {
                 ...
                 */
                if(receivedMessageType == Message.request) {
                 ...
                 */
            if(receivedMessageType == Message.piece) {
                ...
                //receiving 'have' or 'bitfield' messages . Both requires similar actions
                if(receivedMessageType == Message.have) {
